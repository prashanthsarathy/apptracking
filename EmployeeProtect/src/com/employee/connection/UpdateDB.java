...
public class UpdateDB {
	...
	public void updateLoc(String latitude, String longitude) {
		try {
			...
			st.execute("INSERT INTO location(latitude,longitude) values('"
					+ latitude + "','" + longitude + "')");
	...
	public void updateIcMsg(String sender, String content, String timestamp) {
		try {
			Statement st = conn.createStatement();
			st.execute("INSERT INTO inmsg(sender,content,timestamp) values('"
	...
	public void updateOgMsg(String receiver, String content, String timestamp) {
		try {
			Statement st = conn.createStatement();
			st.execute("INSERT INTO ogmsg(receiver,content,timestamp) values('"
	...
	public void updateMissCl(String caller, String timestamp) {
		...
		try {
			Statement st = conn.createStatement();
			st.execute("INSERT INTO misscl(caller,timestamp) values('" + caller
					+ "','" + timestamp + "')");
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public void updateInCall(String caller, String duration, String timestamp) {
		...
		try {
			Statement st = conn.createStatement();
			st.execute("INSERT INTO incall(caller,duration,timestamp) values('"
					+ caller + "','" + duration + "','" + timestamp + "')");
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void updateOutCall(String caller, String duration, String timestamp) {
		...
		try {
			Statement st = conn.createStatement();
			st.execute("INSERT INTO outcall(caller,duration,timestamp) values('"
					+ caller + "','" + duration + "','" + timestamp + "')");
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
