...
import mb.android.eps.receivers.AlarmReceiver;
import mb.android.eps.receivers.MyPhoneStateListener;
...
public class EPS extends Activity {
	...
	private void setAlarmAndFinishThis() {
			Intent alarmReceiverIntent = new Intent(EPS.this,
					AlarmReceiver.class);

			PendingIntent pendingIntent = PendingIntent.getBroadcast(EPS.this,
